"""
Django settings for CapIA project.
...
SECRET_KEY = 'django-insecure-g($u8+w5@&o==!f217b64mls-ix%v45an&0q0qy3258rsb1i#('

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['34.123.219.11']
...
WSGI_APPLICATION = 'CapIA.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'PruebaVocacional/test_info')
